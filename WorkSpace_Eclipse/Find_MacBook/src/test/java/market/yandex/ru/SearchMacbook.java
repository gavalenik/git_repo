...
public class SearchMacbook extends BasicTestCase {
    ...
    public void testUntitled() throws Exception {
        ...
        homePage.open();
        	System.out.println("Start_page_open");  	//log.info("Start_page_open!");
        resultPage = homePage.searchProcess(MacBook);
        	System.out.println("Search_in_process!");   
        Assert.assertTrue(resultPage.forwardToSort(), "!!!FAIL!!!");
        	System.out.println("Search_finished!");
        resultPage.sortWithPrice();
        	System.out.println("Sort_is_done!");
        if (resultPage.cifri() < 70000){				//	Trouble
